...
(function () {
  ...
  function totalStars() { let s = P.genStars || 0; for (const k in P.done) s += P.done[k].stars || 0; return s; }
  ...
  /* ---------- Professora Clara ---------- */
  const CLARA_SVG = `<svg viewBox="0 0 100 100" class="avatar" aria-label="Professora Clara"><circle cx="50" cy="50" r="50" fill="#fff"/><circle cx="50" cy="42" r="30" fill="#6b3e26"/><ellipse cx="50" cy="48" rx="24" ry="26" fill="#f6c9a0"/><circle cx="50" cy="16" r="9" fill="#6b3e26"/><path d="M26 44 q24 -30 48 0" fill="#6b3e26"/><circle cx="40" cy="50" r="7" fill="none" stroke="#333" stroke-width="2"/><circle cx="60" cy="50" r="7" fill="none" stroke="#333" stroke-width="2"/><line x1="47" y1="50" x2="53" y2="50" stroke="#333" stroke-width="2"/><circle cx="40" cy="51" r="2.5" fill="#333"/><circle cx="60" cy="51" r="2.5" fill="#333"/><path d="M41 63 q9 8 18 0" stroke="#c0392b" stroke-width="2.5" fill="none" stroke-linecap="round"/><circle cx="33" cy="60" r="3.5" fill="#ffb3b3" opacity=".7"/><circle cx="67" cy="60" r="3.5" fill="#ffb3b3" opacity=".7"/><path d="M22 100 q28 -34 56 0z" fill="#4ECDC4"/><rect x="43" y="74" width="14" height="10" rx="2" fill="#f6c9a0"/></svg>`;
  ...
  document.addEventListener('click', e => {
    ...
    const rd = e.target.closest('[data-redo]'); if (rd) { delete P.done[rd.dataset.redo]; save(); route(); }
  });
